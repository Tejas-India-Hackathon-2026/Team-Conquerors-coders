...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f8fafc] text-slate-900 font-sans selection:bg-orange-500 selection:text-white relative">
      
      {/* Ambient Lighting Mesh Glow */}
      <div className="ambient-bg-glow-light" />
              ...
              {hasSearched ? (
                <>
                  ...
                  <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 text-left">
                    ...
                    {playingAudioId === 'results-summary' && (
                      <div className="mb-6 p-4 rounded-2xl bg-orange-50 border-2 border-orange-300 flex items-center justify-between gap-3 shadow-md animate-pulse">
                        <div className="flex items-center gap-3">
                          <Volume2 className="w-6 h-6 text-orange-600 shrink-0" />
                          <span className="text-sm sm:text-base font-extrabold text-orange-900">
                            🔊 योजना साथी आपको रिजल्ट बोलकर सुना रहा है... सुनते रहें!
                          </span>
                        </div>
                        <button
                          onClick={handleStopAudio}
                          className="px-3.5 py-1.5 rounded-xl bg-white hover:bg-slate-100 text-xs font-bold text-slate-700 border border-slate-300 shadow-sm"
                        >
                          रोकें (Stop)
                        </button>
                      </div>
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        {matchedSchemes.length > 0 && (
                          <button
                            ...
                            className="text-xs font-bold text-slate-700 hover:text-slate-900 bg-white hover:bg-slate-50 border border-slate-300 px-3.5 py-2 rounded-xl transition-all flex items-center gap-1.5 shadow-sm"
                          >
                        ...
                        <button
                          ...
                          className="text-xs font-bold text-cyan-900 hover:bg-cyan-100 bg-cyan-50 border border-cyan-300 px-3.5 py-2 rounded-xl transition-all flex items-center gap-1.5 shadow-sm"
                        >
                        ...
                        <button
                          ...
                          className="text-xs font-bold text-slate-700 hover:text-slate-900 bg-white border border-slate-300 hover:bg-slate-50 px-3.5 py-2 rounded-xl transition-all flex items-center gap-1.5 shadow-sm"
                        >
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-4 text-left">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
                    ...
                    <button
                      onClick={() => setActiveTab('directory')}
                      className="text-xs font-bold text-orange-700 hover:text-orange-900 bg-orange-50 border border-orange-200 hover:bg-orange-100 px-4 py-2.5 rounded-2xl transition-all flex items-center gap-1.5 self-start sm:self-auto shadow-sm"
                    >
                      <Layers className="w-4 h-4 text-orange-600" />
