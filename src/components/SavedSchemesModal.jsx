        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-6">
          ...
          {savedSchemes.length > 0 && (
            <button
              ...
              className="text-xs text-rose-400 hover:text-rose-300 font-semibold flex items-center gap-1 self-start sm:self-auto bg-slate-950 px-3 py-1.5 rounded-xl border border-rose-500/30"
            >
        ...
        {savedSchemes.length === 0 ? (
          <div className="text-center py-16 bg-slate-950/60 border border-slate-800 rounded-3xl p-6">
            ...
            <p className="text-xs text-slate-500 mt-1 max-w-sm mx-auto">
              होमपेज या डायरेक्टरी में किसी भी योजना कार्ड पर बने स्टार (⭐) या बुकमार्क बटन को दबाकर उसे यहाँ सेव करें।
            </p>
            <button
              onClick={onClose}
          ...
          <div className="space-y-3.5">
            {savedSchemes.map((scheme) => (
              <div
                key={scheme.id}
                className="p-4 bg-slate-950 rounded-2xl border border-slate-800 hover:border-slate-700 transition-all flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 group"
              >
                <div className="flex-1">
                  ...
                  <h4 className="text-sm sm:text-base font-bold text-white group-hover:text-orange-300 transition-colors">
                    {scheme.hindiName}
                  </h4>
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto justify-end pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-800/80">
                  ...
                  <button
                    ...
                    className="px-3.5 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 hover:text-white text-xs font-bold border border-slate-800 flex items-center gap-1"
                  >
                    <span>विवरण</span>
