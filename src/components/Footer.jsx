...
export default function Footer({ onOpenTeam }) {
  return (
    <footer className="mt-16 border-t border-slate-800/80 bg-slate-950/90 py-10 px-4 sm:px-6 lg:px-8 text-center backdrop-blur-2xl">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        
        {/* Left */}
        <div className="flex items-center gap-2 text-left">
          <div className="w-8 h-8 rounded-xl bg-orange-500/15 border border-orange-500/30 flex items-center justify-center text-sm shadow-sm">
            🇮🇳
          </div>
          <div>
