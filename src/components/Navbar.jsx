...
import { Sparkles, MapPin, Users, BarChart3, Activity } from 'lucide-react';

export default function Navbar({ onOpenCsc, onOpenTeam, onOpenAnalytics, onOpenDirectory, activeTab, setActiveTab }) {
  return (
