...
export default function SchemeCard({
  ...
  return (
    <div className="bg-gradient-to-b from-slate-900/90 via-slate-900/80 to-slate-950/90 backdrop-blur-xl border border-slate-800/90 hover:border-orange-500/40 rounded-3xl p-6 sm:p-7 transition-all duration-300 shadow-xl flex flex-col justify-between group aurora-card relative overflow-hidden text-left">
      ...
      <div>
        ...
        {/* Total Benefit Highlight Box (Metallic Radiant Glow) */}
