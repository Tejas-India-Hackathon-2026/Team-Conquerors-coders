...
export default function PricingModal({ onClose, isPremium, onActivateTrial, onActivatePremium }) {
  const [billingCycle, setBillingCycle] = useState('monthly'); // 'monthly' | 'yearly' | 'perForm'
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-4xl bg-slate-900 border border-slate-700/80 rounded-3xl p-6 sm:p-8 shadow-2xl my-8 text-left max-h-[92vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
          ...
          {/* Plan 1: Free Tier */}
          <div className="bg-slate-950/70 border border-slate-800 rounded-3xl p-5 flex flex-col justify-between">
            <div>
              ...
              <p className="text-[11px] text-slate-400 mt-1">बुनियादी योजना खोज व जानकारी</p>

              <div className="mt-4 pt-4 border-t border-slate-800/80 space-y-2.5 text-xs text-slate-300">
                <div className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-emerald-400 shrink-0" />
                  <span>आवाज़ से 10+ योजनाओं की खोज</span>
                </div>
                <div className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-emerald-400 shrink-0" />
          ...
          <div className="relative bg-gradient-to-b from-orange-500/15 via-slate-900 to-slate-950 border-2 border-orange-500/80 rounded-3xl p-5 flex flex-col justify-between shadow-2xl shadow-orange-500/10 scale-105">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full bg-gradient-to-r from-orange-500 to-amber-500 text-white text-[10px] font-extrabold uppercase tracking-wider shadow">
            ...
            <div>
              <div className="text-xs font-bold text-orange-400 uppercase tracking-wider flex items-center gap-1">
                <Crown className="w-3.5 h-3.5" /> नागरिक प्रीमियम (Citizen Pro)
              </div>
              <div className="text-3xl font-black text-white mt-1">
                ₹29 <span className="text-xs font-normal text-slate-400">/ महीना</span>
                <span className="text-[11px] font-bold text-emerald-400 block mt-0.5">या ₹19 प्रति फॉर्म</span>
              </div>
              <p className="text-[11px] text-orange-200 mt-1">3 दिन का फ्री ट्रायल शामिल!</p>
            ...
            <div className="mt-6 space-y-2">
              <button
                ...
                className="w-full py-3 rounded-xl bg-gradient-to-r from-orange-500 via-amber-500 to-emerald-600 hover:from-orange-600 hover:to-emerald-700 text-white font-extrabold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-lg shadow-orange-500/20 hover:scale-[1.02] transition-all"
              >
          ...
          <div className="bg-slate-950/70 border border-slate-800 rounded-3xl p-5 flex flex-col justify-between">
            <div>
              ...
              <p className="text-[11px] text-slate-400 mt-1">मुखिया, CSC VLEs एवं NGO कैम्प्स</p>
            ...
            <button
              ...
              className="mt-6 w-full py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs transition-colors"
            >
        ...
        <div className="pt-4 border-t border-slate-800 text-center flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-400">
          <div className="flex items-center gap-2">
            ...
            <span>100% सुरक्षित भुगतान | UPI, QR, PhonePe, Paytm समर्थित</span>
          </div>
