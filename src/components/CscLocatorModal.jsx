      ...
      <div className="relative w-full max-w-2xl bg-slate-900 border border-slate-700/80 rounded-3xl p-6 sm:p-8 shadow-2xl text-left">
        ...
        <div className="my-5">
          ...
          <select
            ...
            className="w-full bg-slate-950 border border-slate-800 rounded-2xl p-3.5 text-sm sm:text-base text-slate-100 focus:outline-none focus:border-emerald-500 transition-all font-semibold"
          >
        ...
        <div className="p-5 rounded-2xl bg-gradient-to-r from-emerald-500/10 via-slate-900 to-slate-950 border border-emerald-500/20 my-4 space-y-3">
        ...
        <div className="mt-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs">
            <div className="p-3 bg-slate-950/60 rounded-xl border border-slate-800 flex items-center justify-between">
              <span className="text-slate-400">किसान कॉल सेंटर:</span>
              <span className="font-bold text-orange-400">{CSC_HELPLINES.biharKisanHelp}</span>
            </div>
            <div className="p-3 bg-slate-950/60 rounded-xl border border-slate-800 flex items-center justify-between">
              <span className="text-slate-400">आयुष्मान भारत टोल-फ्री:</span>
              <span className="font-bold text-rose-400">{CSC_HELPLINES.ayushmanTollFree}</span>
            </div>
            <div className="p-3 bg-slate-950/60 rounded-xl border border-slate-800 flex items-center justify-between">
              <span className="text-slate-400">बिहार RTPS सेवा हेल्पलाइन:</span>
              <span className="font-bold text-emerald-400">{CSC_HELPLINES.biharRTPSHelp}</span>
            </div>
            <div className="p-3 bg-slate-950/60 rounded-xl border border-slate-800 flex items-center justify-between">
              <span className="text-slate-400">महिला हेल्पलाइन:</span>
              <span className="font-bold text-pink-400">{CSC_HELPLINES.womenHelpline}</span>
            </div>
          </div>
        </div>
