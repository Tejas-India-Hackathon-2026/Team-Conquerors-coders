...
export default function CscLocatorModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm overflow-y-auto">
      ...
      <div className="relative w-full max-w-2xl bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-8 shadow-2xl text-left">
        ...
        <div className="flex items-center gap-3 mb-2">
          <div className="w-10 h-10 rounded-2xl bg-emerald-100 border border-emerald-300 flex items-center justify-center shadow-sm">
        ...
        <div className="my-5">
          ...
          <select
            ...
            className="w-full bg-slate-50 border border-slate-200 rounded-2xl p-3.5 text-sm sm:text-base text-slate-900 focus:outline-none focus:border-emerald-500 transition-all font-bold shadow-sm"
          >
        ...
        <div className="p-5 rounded-2xl bg-emerald-50/60 border border-emerald-200 my-4 space-y-3 shadow-sm">
          
          <div className="flex items-center justify-between">
            <span className="text-xs text-emerald-950 font-bold uppercase tracking-wider">
          ...
          <div className="flex items-center gap-2.5 pt-2 border-t border-emerald-200/80">
            <PhoneCall className="w-4 h-4 text-emerald-700" />
            <span className="text-xs text-slate-700">
              जिला हेल्पलाइन: <span className="font-bold text-slate-900">{currentDistrict.helpline}</span>
            </span>
          </div>
        ...
        <div className="mt-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs">
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between">
              <span className="text-slate-700 font-medium">CSC राष्ट्रीय सहायता:</span>
              <span className="font-bold text-slate-900">{CSC_HELPLINES.nationalTollFree}</span>
            </div>
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between">
              <span className="text-slate-700 font-medium">बिहार RTPS सेवा:</span>
              <span className="font-bold text-slate-900">{CSC_HELPLINES.biharRTPSHelp}</span>
            </div>
          </div>
        </div>
