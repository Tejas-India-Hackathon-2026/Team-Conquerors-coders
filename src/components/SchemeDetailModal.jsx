...
export default function SchemeDetailModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md overflow-y-auto">
      ...
      <div className="relative w-full max-w-3xl bg-slate-900/95 border border-slate-700/80 rounded-3xl p-6 sm:p-8 shadow-2xl my-8 text-left max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            {onOpenFlyer && (
              <button
                ...
                className="px-3.5 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 hover:text-white text-xs font-bold border border-slate-700 flex items-center gap-1.5 shadow"
                title="A4 पोस्टर"
              >
            ...
            <button
              ...
              className="flex-1 sm:flex-initial px-5 py-2.5 rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-extrabold text-xs flex items-center justify-center gap-1.5 shrink-0 shadow-lg shadow-orange-500/25 hover:scale-105 transition-all"
            >
